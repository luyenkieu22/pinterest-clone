                ...
                <div className="createBottom">
                    {previewImg?.url ? (
                        ...
                        <label htmlFor="file" className="upload">
                            ...
                            <div className="uploadInfo">We recommend using high quality .jpg files les than 20 files les than 200MB.</div>
                        </label>
                        <input hidden type="file" id="file" onChange={e => setFile(e.target.files[0])} />
                    </>
                    )}
